...
public class CasualWomenShoe extends Fragment {
    ...
    Context context;
    public CasualWomenShoe(Context context1) {
        this.context=context1;
        // Required empty public constructor
    }
    ArrayList<D_ShoesDataFromInternet> arrayListCasual =new ArrayList<>();
    AdapterForCasualWomen adapterForCasualWomen;
    @Override
    ...
    public void setListView(View view) {
        ListView listView=view.findViewById(R.id.ListViewInCasualWomen);
        adapterForCasualWomen =new AdapterForCasualWomen(context,R.layout.single_view_for_label_of_shoe, arrayListCasual,"Casual");
        listView.setAdapter(adapterForCasualWomen);
    }

    public void getArrayListData()
    {
        DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference("WomenFootWear").child("Casual");
    ...
    class AdapterForCasualWomen extends ArrayAdapter<D_ShoesDataFromInternet>
    {
        ...
        AdapterForCasualWomen(@NonNull Context context, int resource, @NonNull ArrayList<D_ShoesDataFromInternet> objects, String ImageCategory) {
