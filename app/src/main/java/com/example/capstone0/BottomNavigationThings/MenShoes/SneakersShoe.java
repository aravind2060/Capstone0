 ...
 */
public class SneakersShoe extends Fragment {


    ArrayList<D_ShoesDataFromInternet> arrayListSneakers=new ArrayList<>();
    Context context;
    MyAdapterSneakers myAdapterSneakers;

    SneakersShoe(Context context)
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=LayoutInflater.from(context).inflate(R.layout.fragment_sneakers_shoe,container,false);
        getArrayListData();
        setListView(view);
        return view;
    }
    public void setListView(View view) {
        ListView listView=view.findViewById(R.id.ListViewInSneakersMen);
         myAdapterSneakers=new MyAdapterSneakers(context,R.layout.single_view_for_label_of_shoe,arrayListSneakers,"Sneakers");
        listView.setAdapter(myAdapterSneakers);
    }
    ...
    class MyAdapterSneakers extends ArrayAdapter<D_ShoesDataFromInternet>
    {
        ...
        MyAdapterSneakers(@NonNull Context context, int resource, @NonNull ArrayList<D_ShoesDataFromInternet> objects, String ImageCategory) {
