...
public class SmartWomenShoe extends Fragment {
    ...
    Context context;
    public SmartWomenShoe(Context context1) {
        this.context=context1;
        // Required empty public constructor
    }
    ArrayList<D_ShoesDataFromInternet> arrayListSmart =new ArrayList<>();
    AdapterForSmartWomen adapterForSmartWomen;
    @Override
    ...
    public void setListView(View view) {
        ListView listView=view.findViewById(R.id.ListViewInSmartWomen);
        adapterForSmartWomen =new AdapterForSmartWomen(context,R.layout.single_view_for_label_of_shoe, arrayListSmart,"Smart");
        listView.setAdapter(adapterForSmartWomen);
    }
    ...
    class AdapterForSmartWomen extends ArrayAdapter<D_ShoesDataFromInternet>
    {
        ...
        AdapterForSmartWomen(@NonNull Context context, int resource, @NonNull ArrayList<D_ShoesDataFromInternet> objects, String ImageCategory) {
