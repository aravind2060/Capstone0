...
public class EthnicWomenShoe extends Fragment {
    ...
    Context context;
    public EthnicWomenShoe(Context context1) {
        this.context=context1;
        // Required empty public constructor
    }
    ArrayList<D_ShoesDataFromInternet> arrayListEthnic =new ArrayList<>();
    AdapterForEthnicWomen adapterForEthnicWomen;
    @Override
    ...
    public void setListView(View view) {
        ListView listView=view.findViewById(R.id.ListViewInEthnicWomen);
        adapterForEthnicWomen =new AdapterForEthnicWomen(context,R.layout.single_view_for_label_of_shoe, arrayListEthnic,"Ethnic");
        listView.setAdapter(adapterForEthnicWomen);
    }
    ...
    class AdapterForEthnicWomen extends ArrayAdapter<D_ShoesDataFromInternet>
    {
        ...
        AdapterForEthnicWomen(@NonNull Context context, int resource, @NonNull ArrayList<D_ShoesDataFromInternet> objects, String ImageCategory) {
