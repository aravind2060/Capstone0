...
public class SportsWomenShoe extends Fragment {
    ...
    Context context;
    public SportsWomenShoe(Context context1) {
        this.context=context1;
        // Required empty public constructor
    }
    ArrayList<D_ShoesDataFromInternet> arrayListSports=new ArrayList<>();
    AdapterForSportsWomen adapterForSportsWomen;
    @Override
    ...
    public void setListView(View view) {
        ListView listView=view.findViewById(R.id.ListViewInSportsWomen);
        adapterForSportsWomen=new AdapterForSportsWomen(context,R.layout.single_view_for_label_of_shoe, arrayListSports,"Sports");
        listView.setAdapter(adapterForSportsWomen);
    }
    ...
    class AdapterForSportsWomen extends ArrayAdapter<D_ShoesDataFromInternet>
    {
        ...
        AdapterForSportsWomen(@NonNull Context context, int resource, @NonNull ArrayList<D_ShoesDataFromInternet> objects, String ImageCategory) {
