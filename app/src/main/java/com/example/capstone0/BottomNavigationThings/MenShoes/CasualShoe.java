...
public class CasualShoe extends Fragment {
    ...
    Context context;
     MyAdapterCasual myAdapterCasual;
    ...
    public void setListView(View view) {
        ListView listView=view.findViewById(R.id.ListViewInCasualMen);
       myAdapterCasual=new MyAdapterCasual(context,R.layout.single_view_for_label_of_shoe,arrayListCasual,"Casual");
        listView.setAdapter(myAdapterCasual);
    }
    ...
    class MyAdapterCasual extends ArrayAdapter<D_ShoesDataFromInternet>
    {
        ...
        Uri downloadableuri=null;
         MyAdapterCasual(@NonNull Context context, int resource, @NonNull ArrayList<D_ShoesDataFromInternet> objects, String ImageCategory) {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            if(position<d_shoesDataFromInternets.size()) {
                ...
                storageReference.child(ImageCategory).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    @Override
